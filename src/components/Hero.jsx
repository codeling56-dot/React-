  ...
  return (
   <div className="relative w-full h-screen overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center">
        {/* REMOVED: backdrop-blur-md, bg-[#1A1A1A]/20, and border-white/10 */}
        {/* ADDED: bg-[#1A1A1A] (solid dark grey) or use bg-black/80 for a dark tint */}
        <div className="flex flex-col items-center gap-6 text-center px-12 py-10 rounded-xl">
